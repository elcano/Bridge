#pragma once
/* SensorHub / High-Level Due per-vehicle settings template.
...
// Distance (meters) within which a waypoint is considered reached.
#define WAYPOINT_RADIUS_M 2.0
